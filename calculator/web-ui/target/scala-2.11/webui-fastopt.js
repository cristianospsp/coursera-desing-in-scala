...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpr) {
  var pf = new $c_Lcalculator_Calculator$$anonfun$computeValues$1().init___sci_Map(namedExpr);
  var this$1 = $m_sci_Map$();
  var bf = new $c_scg_GenMapFactory$MapCanBuildFrom().init___scg_GenMapFactory(this$1);
  return $as_sci_Map($s_sc_TraversableLike$class__collect__sc_TraversableLike__s_PartialFunction__scg_CanBuildFrom__O(namedExpr, pf, bf))
});
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2) {
    return (function() {
      ...
      if ((x1 > 0)) {
        var array = [(((-$uD(b$2.apply__O())) - $uD($g["Math"]["sqrt"](x1))) / (2 * $uD(a$2.apply__O()))), (((-$uD(b$2.apply__O())) + $uD($g["Math"]["sqrt"](x1))) / (2 * $uD(a$2.apply__O())))];
...
var $c_Lcalculator_Calculator$$anonfun$computeValues$1 = (function() {
  ...
  this.namedExpr$1$f = null
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype = new $h_sr_AbstractPartialFunction();
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.init___sci_Map = (function(namedExpr$1) {
  this.namedExpr$1$f = namedExpr$1;
  return this
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.applyOrElse__T2__F1__O = (function(x1, default$2) {
  if ((x1 !== null)) {
    var k = $as_T(x1.$$und1$f);
    var v = $as_Lcalculator_Signal(x1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, k$1, v$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(v$1.apply__O()), $as_sci_Map(arg$outer.namedExpr$1$f.$$minus__O__sc_Map(k$1)))
      })
    })(this, k, v));
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__T2__Z($as_T2(x))
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.applyOrElse__O__F1__O = (function(x, default$2) {
  return this.applyOrElse__T2__F1__O($as_T2(x), default$2)
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.isDefinedAt__T2__Z = (function(x1) {
  return (x1 !== null)
});
